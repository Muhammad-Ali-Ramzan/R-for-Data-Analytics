...
#7
df7 <- data.frame(
  Group = rep(c("Morning", "Afternoon", "Evening"), each = 10),
  Score = c(rnorm(10, 20, 3),
            rnorm(10, 25, 3),
            rnorm(10, 30, 3))
)
...
#13
df13 <- data.frame(
  Group = rep(c("Mild", "Moderate", "Severe"), each = 10),
  Score = c(rnorm(10, 25, 4),
            rnorm(10, 35, 4),
            rnorm(10, 50, 4))
)
